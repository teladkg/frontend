...
const Clinic = () => {
  ...
  return (
    <>
      <section className={styles.clinic_page}>

        <div id={styles.clinic_page_header}>
          <Link to="/"><p id={styles.logo_title}>Telad</p></Link>
          <h1 id={styles.clinic_page_title}>Запишитесь на приём к врачу онлайн</h1>
        </div>
        ...
        <h1 id={styles.clinic_page_article1}>MEDCENTER.KG</h1>

        <div className={styles.clinic_page_data}>
          <div id={styles.clinic_page_data_imagegroup}>
            <img src={require('../../content/images/profile-clinic/19-scaled2.png')} alt="clinic pic"/>
            <img src={require('../../content/images/profile-clinic/tiles2.png')} alt="clinic pic"/>
          </div>
          <div className={styles.clinic_page_data_text}>
            <div id={styles.clinic_page_data_text_left}>
              <h2 id={styles.clinic_page_data_text_left_title1}>О КЛИНИКЕ</h2>
              <h3 id={styles.clinic_page_data_text_left_title2}>МЕДИЦИНСКИЙ ЦЕНТР  MEDCENTER.KG</h3>
              <p id={styles.clinic_page_data_text_left_article}>Медицинский центр «MEDCENTER.KG» это многопрофильная клиника, расположенная  в самом центре Бишкека .</p>
              <p id={styles.clinic_page_data_text_left_article}>Здесь вы можете получить консультации специалистов различного профиля, прием ведут: Доктора медицинских наук, профессора, отличники здравоохранения и врачи высшей и первой категории.  </p>
              <p id={styles.clinic_page_data_text_left_article}>Медицинский центр.kg оснащен отличной диагностической базой, где проводятся лабораторные, ультразвуковые, эндоскопические, электрофизиологические обследования на современном оборудовании.</p>
            </div>
            <div id={styles.clinic_page_data_text_right}>
              <div id={styles.clinic_page_data_text_right_addressgroup}>
                ...
                <p id={styles.clinic_page_data_text_right_address}>г.Бишкек, улица Чокморова, 154</p>
              </div>
              <div id={styles.clinic_page_data_text_right_timegroup}>
                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p id={styles.clinic_page_data_text_right_time1}>пн-пт: 00:00 - 24:00</p>
              </div>
              <p id={styles.clinic_page_data_text_right_time2}>сб: 00:00 - 24:00</p>
              <p id={styles.clinic_page_data_text_right_time3}>вс: 00:00 - 24:00</p>          
              <div id={styles.clinic_page_data_text_right_phonegroup}>
                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p id={styles.clinic_page_data_text_right_phone}>+996 777 77 77 77</p>
              </div>
              <button id={styles.clinic_page_data_text_right_button}>Связаться</button>
            </div>
          </div>
        </div>

        <h1 id={styles.clinic_page_article2}>Врачи в клинике </h1>
        ...
        <div className={styles.doctors_list}>
          <div id={styles.doctor_list_item}>
            ...
            <div className={styles.doctor_list_item_middle}>
              <Link to="/doctor"><p id={styles.doctor_list_item_middle_name}>Короткий Игорь Валентинович</p></Link>
