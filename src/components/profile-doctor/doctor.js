      ...
      <section className="doctor_page">
        ...
        <div className="doctor_page_doctors">
          <Slider ref={customDoctorSlider} {...doctors_slider}>
            <div id="doctor_page_doctors_slide">
              <img id="doctor_page_doctors_slide_image" src={require('../../content/images/main/image_10.png')} alt="clinic pic"/>
              <div id="doctor_page_doctors_slide_info">
                ...
                <p id="doctor_page_doctors_slide_info_experience">Стаж: 20 лет</p>
                <p id="doctor_page_doctors_slide_info_address">Городская больница №6, Чуй 127</p>
