        ...
        <Slider ref={customClinicSlider} {...clinics_slider}>
          <div id="clinics_slide">
            ...
            <div id="clinics_slide_info">
              ...
              <p id="clinics_slide_info_article">Медицинский центр «Alanda Clinic» -ооо многопрофильная клиника, которатттлтя работает в Астане и Караганде с 2ььь006 года. «Alanda Clinic» объединяет в сььебе поли...поли...поли...поли...поли...поли...пол</p>
              <p id="clinics_slide_info_address">Бишкек , ул Чокморова, 154.</p>
      ...
      <section className="doctors">
        ...
        <Slider ref={customDoctorSlider} {...doctors_slider}>
          <div id="doctors_slide">
            <img id="doctors_slide_image" src={require('../../content/images/main/image_10.png')} alt="clinic pic"/>
            <div id="doctors_slide_info">
              ...
              <p id="doctors_slide_info_experience">Стаж: 20 лет</p>
              <p id="doctors_slide_info_address">Городская больница №6, Чуй 127</p>
