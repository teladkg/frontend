...
import styles from './clinicsSearch.css';
  ...
  return (
    <>
      <section className="clinics_page">
        ...
        <div id="clinics_page_header">
          <Link to="/"><p id="clinics_page_header_logo_title">Telad</p></Link>
          <Link><button id="clinics_page_header_button">Личный кабинет</button></Link>
        </div>

        <div className="clinics_page_group_container">
          <h1 id="clinics_page_group_title">Запишитесь на приём к врачу онлайн</h1>
          <div className="clinics_page_group">
            <Autocomplete
              id="grouped-demo"
            ...
            />
            <Link to="/clinics-search"><button id="clinics_page_group_button">Найти</button></Link>
          </div>
        </div>
        ...
        <h1 id="clinics_page_article1">Все клиники</h1>

        <div className="clinics_page_sort_group">
          <p id="clinics_page_sort_group_title">Сортировать по:</p>
        ...
        <div className="clinics_page_clinics_list">
          <div id="clinics_page_clinic_list_item">           
            <div className="clinics_page_clinic_list_item_left">
              <div className="clinics_page_clinic_list_item_imagegroup">
                <img src={require('../../content/images/main/70e4b3c1bd7d70589e857693212fb33c1.png')} alt="clinic pic"/>
                <p>Stars</p>
              </div>
              <div className="clinics_page_clinic_list_item_textgroup">
                <Link id="clinics_page_clinic_list_item_textgroup_link" to="/clinic"><p id="clinics_page_clinic_list_item_textgroup_title">МЕДИЦИНСКИЙ ЦЕНТР MEDCENTER.KG</p></Link>
                <p id="clinics_page_clinic_list_item_textgroup_article1">Медицинский центр «MEDCENTER.KG» — это многопрофильная клиника, расположенная в самом центре Бишкека.</p>
                <p id="clinics_page_clinic_list_item_textgroup_article2">Здесь вы можете получить консультации специалистов различного профиля, прием ведут: Доктора медицинских наук, профессора, отличники здравоохранения и врачи высшей и первой категории. Оказывают качественную медицинскую помощь.</p>
                {/* <p id="clinics_page_clinic_list_item_textgroup_article3">Медицинский центр.kg оснащен отличной диагностической базой, где проводятся лабораторные, ультразвуковые, эндоскопические, электрофизиологические обследования на современном оборудовании.</p> */}
                {/* <Link id="clinics_page_clinic_list_item_textgroup_link" to="/clinic">Ещё</Link> */}
                {/* <div id="clinics_page_clinic_list_item_textgroup_doctors">
            ...
            <div className="clinics_page_clinic_list_item_right">
              <div id="clinics_page_clinic_list_item_right_addressgroup">
                ...
                <p id="clinics_page_clinic_list_item_right_addresstitle">Адрес:</p>
                <p id="clinics_page_clinic_list_item_right_address">г.Бишкек, улица Чокморова, 154</p>
              </div>
              <div id="clinics_page_clinic_list_item_right_timegroup">
                {/* <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p id="clinics_page_clinic_list_item_right_time1title">График работы:</p>
                <p id="clinics_page_clinic_list_item_right_time1">пн-пт: 00:00 - 24:00</p>
              </div>
              <p id="clinics_page_clinic_list_item_right_time2">сб: 00:00 - 24:00</p>
              <p id="clinics_page_clinic_list_item_right_time3">вс: 00:00 - 24:00</p>          
              <div id="clinics_page_clinic_list_item_right_phonegroup">
                {/* <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p id="clinics_page_clinic_list_item_right_phonetitle">Телефон для связи:</p>
                <p id="clinics_page_clinic_list_item_right_phone">+996 777 77 77 77</p>
              </div>
            </div>
          </div>
          <div id="clinics_page_clinic_list_item">           
